...
class VsrPositions:
    ...
    Z_FINGER_APPROACH: float = (
        23  # Position where VSR can rapidly approach but does not yet contact the finger slopes
    )
    ...
    Z_NEXT_PLATE_LID_APPROACH: float = (
        15  # Position to catch 2nd lid with plate + lid + plate 2 below
    )

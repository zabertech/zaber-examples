...
Zaber Motion Library (ZML) provides a utility function for loading a CSV file with position data, position-time data, or position-velocity-time data, by using the static class methods `PvtSequence.load_partial_sequence_data()` (for when some columns may be missing) and `PvtSequence.load_sequence_data()` (for complete data).
...
Initialize an instance of this class from an array of `PvtPartialPoint` objects generated from position data, by using the static class method `PvtSequence.generate_velocities_and_times()`.
...
Initialize an instance of this class from an array of `PvtPartialPoint` objects generated from position-time data, by using the static class method `PvtSequence.generate_velocities()`.
...
Initialize an instance of this class from an array of `PvtPartialPoint` objects generated from velocity-time data, by using the static class method `PvtSequence.generate_positions()`.
